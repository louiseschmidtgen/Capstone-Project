...
class GermanHolidaysController():
    def __init__(self, dashboard_controller):
        ...
        self.holidaysdict = {
            ...
            "German Unity Day": ["The German Unity Day is celebrated on the 3rd of October as a public holiday. \
            It commemorates the German reunification in 1990 of east and west Germany.", "url"],
            "Holocaust Memorial": ["This Memorial day is on the 27th of February. This date remembers the liberation of the concentration camp Auschwitz in the year 1945. \
