...
class GermanHolidaysGUI(QWidget):
    ...
    def create_main_frame(self):
        ...
        self.carnival_button.clicked.connect(lambda: self.handle_info_request("Carnival")) 
        
        self.christmas_button = QPushButton("i")
        self.christmas_button.setObjectName("i")  
        self.christmas_button.clicked.connect(lambda: self.handle_info_request("Christmas"))    

        self.oktoberfest_button = QPushButton("i")
        self.oktoberfest_button.setObjectName("i")  
        self.oktoberfest_button.clicked.connect(lambda: self.handle_info_request("Oktoberfest")) 
        
        self.gud_button = QPushButton("i")
        self.gud_button.setObjectName("i")  
        self.gud_button.clicked.connect(lambda: self.handle_info_request("German Unity Day")) 
       
        self.holocaust_mem_button = QPushButton("i")
        self.holocaust_mem_button.setObjectName("i")  
        self.holocaust_mem_button.clicked.connect(lambda: self.handle_info_request("Holocaust Memorial")) 
