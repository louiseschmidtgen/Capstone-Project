...
def main():
    ...
    #result: bouquet
    google_api.translate("Übergrößengeschäft", source_lang="ger", target_lang="en")
    #result: mountain business
    google_api.translate("Uebergroeßengeschaeft", source_lang="ger", target_lang="en")
    #result: Huge closeness
    google_api.translate("Käsesoßenrührlöffel", source_lang="ger", target_lang="en")
    #result: K seso enr hrl ffel
    google_api.translate("Kaesesoßenruehrloeffel", source_lang="ger", target_lang="en")
